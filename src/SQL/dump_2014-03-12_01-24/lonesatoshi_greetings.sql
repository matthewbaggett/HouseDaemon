...
CREATE TABLE `greetings` (
  `greeting_id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `greetings` VALUES (1,'Texan','Howdy'),(2,'Californian','Yo'),(3,'British','Hello'),(4,'Yorkshire','Ey up, how\'s tha doin');
...
-- Dump completed on 2014-03-12  1:24:23
